...
#pragma config(Motor,  port1,           Arm1,          tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port2,           DriveLeftFront, tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port3,           DriveRightFront, tmotorNormal, openLoop)
#pragma config(Motor,  port4,           DriveLeftRear, tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port5,           DriveRightRear, tmotorNormal, openLoop)
#pragma config(Motor,  port6,           DriveCenter,   tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port7,           Spinner1,      tmotorNormal, openLoop)
#pragma config(Motor,  port8,           Spinner2,      tmotorNormal, openLoop, reversed)
#pragma config(Motor,  port9,           Descore,       tmotorNormal, openLoop)
#pragma config(Motor,  port10,          Arm2,          tmotorNormal, openLoop)
